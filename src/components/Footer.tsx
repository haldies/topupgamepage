        ...
        <div className="max-w-screen-lg mx-auto px-4 pt-12 pb-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Get your game credits now, fast and secure!</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">Promotions</a></li>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">Subscribe to get updates on our latest offers and promotions.</p>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="bg-gray-800 border border-gray-700 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full"
                />
